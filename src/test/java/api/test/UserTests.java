...
public class UserTests {
	...
	public void testGetUserByName() {
		...
		try{
			Response responseFromReadUser =	UserEndPoints.readUser(this.userpayload.getUsername());
...
//			         //now you have the response, construct json from it, and extract the errors
	...
	public void testUpdateUserByName() {
		...
		Response responseBeforeUpdate=UserEndPoints.updateUser(this.userpayload.getUsername(),userpayload);
